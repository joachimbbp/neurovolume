...
-        return 0;
-    };
+    vdb.putVoxel(arena_alloc, .from(pos.*), value) catch return 0;
     return 1;
...
+    vdb543.writeVDB(&writer.writer, &vdb, transform_matrix) catch {
...
+    file.writeAll(writer.written()) catch {
